...
function ExpressApp(credentials) {
  const app = express();
  const service = new Service(credentials);
  ...
  app.post('/leads', publicAuth(credentials), validate({ body: LeadSchema }), function(req, res) {
  ...
  app.post('/projects', privateAuth(credentials), validate({ body: NewProjectSchema }), function(req, res) {
  ...
  app.get('/account', privateAuth(credentials), function(req, res) {
  ...
  app.get('/projects/:projectId/leads', privateAuth(credentials), function(req, res) {
  ...
  app.get('/projects', privateAuth(credentials), function(req, res) {
